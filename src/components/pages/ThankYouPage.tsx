...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    // Wix flow: after a successful payment, Wix shows its own confirmation page
    // (at checkout.shrisaibridaljewels.com). When the user clicks "Continue Browsing",
    // they land here with ?wixMemberLoggedIn=true.
    // There is no way to reach this page from a failed payment — Wix handles failures
    // entirely on its own domain. So landing here always means success.
    actions.clearCart();
  }, [actions]);
